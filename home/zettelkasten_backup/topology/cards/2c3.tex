...
\zheader{Propiedades de las identificaciones}{2c3}{propiedades, composición, identificación}
...
({\scshape\romannumeral 2}) Como $f$ y $g$ son identificaciones, entonces, por \hyperref[card:2c2]{\textsf{2c2}},
\begin{align*}
