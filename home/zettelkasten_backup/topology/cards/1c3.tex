...
\zheader{Propiedades de las identificaciones}{1c3}{propiedades, composición, identificación}
...
({\scshape\romannumeral 2}) Como $f$ y $g$ son identificaciones, entonces, por \hyperref[card:1c2]{\textsf{1c2}},
\begin{align*}
