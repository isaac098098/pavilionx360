...
static const char *fonts[]          = { "scientifica:weight=medium:size=12" };
static const char dmenufont[]       =   "scientifica:weight=medium:size=12";
...
// static const char *selbks[] = { "rofi", "-show", "select_books", "-config", "~/.config/rofi/short.rasi", "-modes", "\"select_books:~/.config/rofi/scripts/select_books.sh\"", NULL };
// static const char *opnbk[] = { "rofi", "-show", "open_book", "-config", "~/.config/rofi/short.rasi", "-modes", "\"open_book:~/.config/rofi/scripts/open_book.sh\"", NULL };
