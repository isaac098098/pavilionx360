...
\renewcommand{\cftsecpagefont}{} %section page number format
\renewcommand{\cftsubsecpagefont}{} %subsection page number format
...
\renewcommand{\cftsecpresnum}{\textnormal} %section number format
